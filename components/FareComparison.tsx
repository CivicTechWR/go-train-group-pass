      ...
      <CardContent className='space-y-4'>
        ...
        <div className='bg-yellow-50 border border-yellow-200 rounded-lg p-3'>
          ...
          <ul className='text-sm text-yellow-700 space-y-1'>
            <li>
              • <strong>Infrequent travelers</strong> - Don&apos;t travel enough
              for PRESTO discounts
            </li>
            <li>
            ...
            <li>
              • <strong>Cash payers</strong> - Prefer not to use PRESTO system
            </li>
            <li>
              • <strong>Occasional commuters</strong> - Travel less than 35
              times per month
            </li>
          </ul>
        </div>
