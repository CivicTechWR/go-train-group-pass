...
describe('GTFS Date Utilities - Timezone Awareness', () => {
  ...
  describe('getDateTimeFromServiceIdGTFSTimeString', () => {
    it('should convert service ID and time string using default timezone', () => {
      ...
      const result = getDateTimeFromServiceIdGTFSTimeString(
        '20251211',
        '12:30:00' as GTFSTimeString,
      );
  ...
  describe('Integration: Multiple timezone scenarios', () => {
    it('should produce consistent results across different timezones', () => {
      ...
      process.env.TRANSIT_TIMEZONE = 'America/Toronto';
      const toronto1 = getDateTimeFromServiceIdGTFSTimeString(
        '20251211',
        '12:00:00' as GTFSTimeString,
      );
      const toronto2 = getDateTimeFromServiceIdGTFSTimeString(
        '20251211',
        '25:00:00' as GTFSTimeString,
      );
      ...
      process.env.TRANSIT_TIMEZONE = 'America/Vancouver';
      const vancouver1 = getDateTimeFromServiceIdGTFSTimeString(
        '20251211',
        '12:00:00' as GTFSTimeString,
      );
      const vancouver2 = getDateTimeFromServiceIdGTFSTimeString(
        '20251211',
        '25:00:00' as GTFSTimeString,
      );
      ...
      expect(vancouver1.getTime() - toronto1.getTime()).toBe(
        3 * 60 * 60 * 1000,
      );
      expect(vancouver2.getTime() - toronto2.getTime()).toBe(
        3 * 60 * 60 * 1000,
      );
    });
