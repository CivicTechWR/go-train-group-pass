...
export class Migration20251106042208 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "go-train-group-pass"."agency" ("id" varchar(255) not null, "agency_name" varchar(255) not null, "agency_url" varchar(255) not null, "agency_timezone" varchar(255) not null, "agency_lang" varchar(255) null, "agency_phone" varchar(255) null, constraint "agency_pkey" primary key ("id"));`);

    this.addSql(`create table "go-train-group-pass"."gtfs_calendar_dates" ("service_id" varchar(255) not null, "date" date not null, "exception_type" int not null, constraint "gtfs_calendar_dates_pkey" primary key ("service_id", "date"));`);
    this.addSql(`create index "idx_calendar_dates_date" on "go-train-group-pass"."gtfs_calendar_dates" ("date");`);

    this.addSql(`create table "go-train-group-pass"."gtfs_routes" ("id" varchar(255) not null, "route_short_name" varchar(255) not null, "route_long_name" varchar(255) not null, "route_desc" varchar(255) null, "route_type" int not null, "route_url" varchar(255) null, "route_color" varchar(255) null, "route_text_color" varchar(255) null, "agency_id" varchar(255) null, constraint "gtfs_routes_pkey" primary key ("id"));`);

    this.addSql(`create table "go-train-group-pass"."gtfs_stops" ("id" varchar(255) not null, "stop_name" varchar(255) not null, "stop_desc" varchar(255) null, "stop_lat" numeric(10,6) not null, "stop_lon" numeric(10,6) not null, "zone_id" varchar(255) null, "stop_url" varchar(255) null, "location_type" int null, "parent_station" varchar(255) null, "wheelchair_boarding" int null, constraint "gtfs_stops_pkey" primary key ("id"));`);

    this.addSql(`create table "go-train-group-pass"."gtfs_trips" ("id" varchar(255) not null, "calendar_date_service_id" varchar(255) not null, "calendar_date_date" date not null, "trip_headsign" varchar(255) null, "trip_short_name" varchar(255) null, "direction_id" int null, "block_id" varchar(255) null, "shape_id" varchar(255) null, "wheelchair_accessible" int null, "bikes_allowed" int null, "route_id" varchar(255) not null, constraint "gtfs_trips_pkey" primary key ("id"));`);
