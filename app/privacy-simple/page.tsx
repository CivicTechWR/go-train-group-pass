      ...
      <div className="container max-w-4xl mx-auto px-4 py-6 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                ...
                <ul className="text-sm text-green-700 space-y-1">
                  ...
                  <li>• Where you live (beyond knowing you take the GO Train)</li>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold mb-2 text-green-600">People in Your Group</h3>
                <p className="text-sm text-muted-foreground">
                  Other people in your train group can see your name and photo. This helps you find each other at the station.
                </p>
              </div>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-4">
              <div>
                ...
                <ul className="text-sm space-y-1 ml-4">
                  <li>• <strong>You delete your account</strong> - then we delete everything</li>
                  <li>• <strong>You stop using the app for 2 years</strong> - then we clean up old accounts</li>
                  <li>• <strong>Pass photos for 48 hours</strong> - then we automatically delete them</li>
                </ul>
              </div>
