...
import { HelpCircle, DollarSign, Users, Calculator, AlertTriangle, ExternalLink } from 'lucide-react';
      ...
      <div className="container max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Everything you need to know about the GO Train Group Pass Coordination App
          </p>
        </div>
            ...
            <div className="space-y-4">
              <div className="bg-white border border-green-200 rounded-lg p-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    <h4 className="font-semibold text-green-600">Group Pass (5 people)</h4>
                    <ul className="text-sm space-y-1">
                      <li>• <strong>Total cost:</strong> $60.00</li>
                      <li>• <strong>Per person:</strong> $12.00</li>
                      <li>• <strong>Round trip included</strong></li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="bg-white border border-green-200 rounded-lg p-4">
                <h3 className="font-bold text-green-800 mb-3">📊 PRESTO Fare Types & Discounts</h3>
                <p className="text-sm text-muted-foreground mb-3">
                  Based on information from the <a href="https://www.prestocard.ca/en/about/fare-types-and-discounts" target="_blank" rel="noopener" className="text-blue-600 hover:underline">PRESTO fare types page</a>:
                </p>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h3 className="font-bold text-blue-800 mb-2">🧮 Calculate Your Exact Savings</h3>
                <p className="text-sm text-blue-700 mb-3">
                  Use the official GO Transit fare calculator to see your individual fare:
                </p>
                <a 
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              ...
              <div>
                <h3 className="font-semibold mb-2">Is this app affiliated with GO Transit?</h3>
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                  <p className="text-sm text-yellow-800 font-semibold">
                    <strong>No!</strong> This app is NOT owned by GO Transit, Metrolinx, or any government agency. 
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Yes, you need a PRESTO card to buy group passes from GO Transit. The steward will use their 
                  PRESTO card to purchase the group pass, and everyone pays them back.
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="text-sm space-y-1 ml-4 mt-2">
                  <li>• <strong>5 people:</strong> $12.00 each (total $60.00)</li>
                  <li>• <strong>4 people:</strong> $12.50 each (total $50.00)</li>
                  <li>• <strong>3 people:</strong> $13.33 each (total $40.00)</li>
                  <li>• <strong>2 people:</strong> $15.00 each (total $30.00)</li>
                </ul>
              </div>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  The app automatically puts people in groups of 4-5 to minimize costs. Groups are formed as people 
                  join the same train trip. The algorithm tries to balance group sizes to keep costs low for everyone.
                </p>
              </div>
              ...
              <div>
                <h3 className="font-semibold mb-2">What if someone in my group is being rude?</h3>
                <p className="text-sm text-muted-foreground">
                  Report them to us and we can ban them from the app. We want to keep the community friendly 
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              ...
              <div>
                <h3 className="font-semibold mb-2">How do I get notifications?</h3>
                <p className="text-sm text-muted-foreground">
                  The app will ask for permission to send you push notifications. These are important for 
                  fare inspection alerts and payment reminders. You can turn them off in your browser settings.
                </p>
              </div>
            </div>
          </CardContent>
