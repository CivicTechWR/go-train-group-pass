...
import { Users, Train, AlertTriangle, BarChart3, Settings, Shield } from 'lucide-react';
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Monitor and manage the GO Train Group Pass system</p>
        </div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-500">
                          ...
                          Payment Rate: {(user.on_time_payment_rate * 100).toFixed(1)}%
                        </div>
                      </div>
                    </div>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div>
                  ...
                  <div className="text-sm text-gray-600">Clean up old data and optimize performance</div>
                </div>
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div>
                  ...
                  <div className="text-sm text-gray-600">Check for security vulnerabilities</div>
                </div>
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div>
                  ...
                  <div className="text-sm text-gray-600">View system and security logs</div>
                </div>
