      ...
      <div className='container max-w-6xl mx-auto px-4 py-12'>
        ...
        <div className='grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-12'>
          <Card>
            ...
            <CardContent>
              <p className='text-sm text-muted-foreground'>
                Automatically groups 4-5 people together to minimize costs and
                maximize savings.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className='text-sm text-muted-foreground'>
                Save up to 69% on your GO Train fare by sharing group passes
          ...
          <Card>
            ...
            <CardContent>
              <p className='text-sm text-muted-foreground'>
                Volunteer to buy passes or join existing groups. Track payments
          ...
          <Card>
            ...
            <CardContent>
              <p className='text-sm text-muted-foreground'>
                Get instant notifications about fare inspections and group
                updates.
              </p>
            </CardContent>
          </Card>
          ...
          <CardContent>
            <div className='grid gap-6 md:grid-cols-3'>
              <div className='text-center'>
                ...
                <p className='text-sm text-muted-foreground'>
                  Browse available trains and join a trip that works for your
                  schedule.
                </p>
              </div>
              <div className='text-center'>
                ...
                <p className='text-sm text-muted-foreground'>
                  The app automatically groups you with 4-5 other people for
                  maximum savings.
                </p>
              </div>
              <div className='text-center'>
                ...
                <p className='text-sm text-muted-foreground'>
                  Pay your share to the steward and enjoy your discounted train
                  ride!
                </p>
              </div>
            </div>
        ...
        <div className='text-center'>
          ...
          <p className='text-muted-foreground mb-6'>
            Join thousands of commuters who are already saving money on their GO
            Train trips.
          </p>
          <a
            href='/today'
