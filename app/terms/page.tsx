...
import { FileText, AlertTriangle, Shield, Users, CreditCard, Phone } from 'lucide-react';
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                <h3 className="font-semibold text-red-600">What You Cannot Do</h3>
                <ul className="text-sm space-y-1 text-muted-foreground">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="text-sm space-y-1 ml-4">
                  <li>• <strong>Group Formation:</strong> Automatically groups riders to optimize costs</li>
                  <li>• <strong>Payment Tracking:</strong> Helps stewards track who has paid</li>
                  <li>• <strong>Real-time Updates:</strong> Live updates when group members join/leave</li>
                  <li>• <strong>Fare Inspection Alerts:</strong> Emergency notifications about fare inspections</li>
                  <li>• <strong>Coach Reporting:</strong> Track which coach and level group members board</li>
                </ul>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="text-sm space-y-1 ml-4">
                  <li>• Use the app only for legitimate GO Transit group pass coordination</li>
              ...
              <div>
                ...
                <ul className="text-sm space-y-1 ml-4">
                  ...
                  <li>• Use only legitimate payment methods (Interac e-Transfer)</li>
                  <li>• Mark payments as sent when completed</li>
                  <li>• Resolve payment disputes directly with group members</li>
                </ul>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-4">
              <div>
                ...
                <ul className="text-sm space-y-1 ml-4">
                  <li>• Use the app for any purpose other than GO Transit group pass coordination</li>
                  <li>• Create fake accounts or impersonate others</li>
                  <li>• Share false information about trips, payments, or other users</li>
                  <li>• Use the app to violate any laws or regulations</li>
                  <li>• Attempt to hack, disrupt, or damage the app or its infrastructure</li>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-4">
              ...
              <div>
                <h3 className="font-semibold mb-2">Payment Responsibilities</h3>
                <ul className="text-sm space-y-1 ml-4">
                  <li>• <strong>Stewards:</strong> Responsible for purchasing group passes and collecting payments</li>
                  <li>• <strong>Group Members:</strong> Responsible for paying their share promptly</li>
                  <li>• <strong>Disputes:</strong> Payment disputes must be resolved between group members</li>
                  <li>• <strong>Refunds:</strong> We do not handle refunds; coordinate directly with group members</li>
                </ul>
              </div>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="text-sm space-y-1 ml-4">
                  <li>• Your display name and profile photo are visible to group members</li>
                  <li>• Trip participation data is shared with group members</li>
                  <li>• We do not sell your data to third parties</li>
                  <li>• We may share data as required by law or to protect our rights</li>
                </ul>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="text-sm space-y-1 ml-4">
                  <li>• We do not guarantee the availability of group passes</li>
                  <li>• We do not guarantee the accuracy of trip information</li>
                  <li>• We do not guarantee the reliability of other users</li>
                  <li>• We do not guarantee the app will be error-free or always available</li>
                </ul>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="text-sm space-y-1 ml-4">
                  ...
                  <li>• You remain responsible for any outstanding payments to group members</li>
                </ul>
              </div>
            </div>
          </CardContent>
